...
GOLDEN_1_OUTPUT = (
    "[ROLE / PERSONA]\n"
    "You are a senior personal finance and small business specialist who performs thorough analysis and identifies improvements.\n"
    "\n"
    "[CONTEXT]\n"
    "Working on: I need help with two things \u2014 across multiple related goals.\n"
    "Key details: Also, analyze my AMEX card \u2014 I have a $10,000 credit limit and a 15,000 point signup bonus after spending $6,000 in 3 months\n"
    "Domain: personal finance and small business.\n"
    "Assume a non-technical business owner audience \u2014 plain language, no jargon.\n"
    "\n"
    "[TASK]\n"
    "Address each of the following systematically:\n"
    "1. I need help with two things.\n"
    "2. Review my vending machine side hustle and help me plan the next steps.\n"
    ...
    "- Be direct and concise \u2014 avoid filler, repetition, and unnecessary caveats."
)
...
GOLDEN_2_OUTPUT = (
    "[ROLE / PERSONA]\n"
    "You are a senior frontend development specialist who architects and builds production-quality solutions, with deep expertise in Python and specific experience with game logic and interactive systems.\n"
    "\n"
    "[CONTEXT]\n"
    "The goal is to build: a command-line tic-tac-toe game in Python with an unbeatable AI opponent.\n"
    "Domain: frontend development.\n"
    "Key technologies involved: Python.\n"
    "Assume a technical developer audience familiar with the relevant concepts.\n"
    "\n"
    "[TASK]\n"
    "Design and implement a command-line tic-tac-toe game in Python with an unbeatable AI opponent.\n"
    "Cover: (1) overall architecture and how components fit together, (2) step-by-step implementation with concrete code examples, (3) error handling and edge cases.\n"
    "\n"
    "Think through this systematically: requirements first, then architecture, then implementation details.\n"
    "\n"
